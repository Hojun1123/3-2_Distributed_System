...
ip = ipaddr.ip[:]
sshport = ipaddr.sshport[:]
dbport = ipaddr.dbport[:]
...
def main():
    ...
    connect_db()
    filenum = 8800
    th1 = Thread(target=work, args=(1, file_list[0:2200], run_time1))
    th2 = Thread(target=work, args=(2, file_list[2200:4400], run_time2))
    th3 = Thread(target=work, args=(3, file_list[4400:6600], run_time3))
    th4 = Thread(target=work, args=(4, file_list[6600:8800], run_time4))
    ...
    send_list3 = [f"{run_time3[1] - run_time3[0]:.4f} sec", f"{run_time3[2] - run_time3[0]:.4f} sec"]
    send_list4 = [f"{run_time4[1] - run_time4[0]:.4f} sec", f"{run_time4[2] - run_time4[0]:.4f} sec"]
    return [send_list1, send_list2, send_list3, send_list4]
